...
import 'package:flutter_application_5/config_reader.dart';
  ...
  group("calculator", () {
    testWidgets('initial State', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
          home: Provider.value(
              value: ThemeData(backgroundColor: Colors.red), child: MyApp())));
    ...
    testWidgets("div two number with two digits", (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(home: Calc()));
    ...
    testWidgets("div on zero should not done", (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(home: Calc()));
